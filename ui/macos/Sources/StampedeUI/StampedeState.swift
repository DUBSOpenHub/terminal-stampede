...
/// Reads live state from the Stampede filesystem queue.
/// Directory layout: ~/.copilot/stampede/{run_id}/{queue,claimed,results,logs,pids,fleet.json}
@MainActor
